...
class _$CustomerListResponse extends CustomerListResponse {
  @override
  final BuiltList<Customer> customerId;
  @override
  ...
  _$CustomerListResponse._(
    ...
    BuiltValueNullFieldError.checkNotNull(
        customerId, r'CustomerListResponse', 'customerId');
    BuiltValueNullFieldError.checkNotNull(
...
class CustomerListResponseBuilder
  ...
  ListBuilder<Customer>? _customerId;
  ListBuilder<Customer> get customerId =>
      _$this._customerId ??= new ListBuilder<Customer>();
  set customerId(ListBuilder<Customer>? customerId) =>
